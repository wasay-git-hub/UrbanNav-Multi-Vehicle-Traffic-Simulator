# UrbanNav - Multi-Vehicle Traffic Simulator

## 📋 Executive Summary

This is a **Multi-Vehicle Traffic Simulation System** that simulates realistic urban traffic patterns using advanced pathfinding algorithms (Dynamic A*), physics-based vehicle movement, and dynamic congestion analysis. The system provides real-time visualization of traffic flow with support for multiple vehicle types, traffic incidents, and road blockages.

## 🎯 Project Purpose

The system is designed for:
- **Traffic Flow Analysis**: Study how different vehicle types interact in a road network
- **Route Optimization**: Demonstrate A* pathfinding with dynamic traffic conditions (D*)
...
- **D* Algorithm**: Optimal pathfinding with euclidean distance heuristic (A* with dynamic conditions)
...
- **Uvicorn**: ASGI server
- **Core Libraries**:
  - `heapq`: Priority queue for dynamic A*
